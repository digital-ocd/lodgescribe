module ApplicationHelper
  ...
  def admin_link_to(link_text, link_path, icon_css)
    content_tag(:li) do
      link_to link_path, class: "submenu" do
  ...
  #   tag_list.map { |t| link_to raw("<i class='icon-tag'></i> #{t.downcase}"), tag_path(t.parameterize) }.join(', ').html_safe
  # end
