class Accounts::MembersController < AccountsController
  ...
  # GET /:sub_domain/members
  # GET /:sub_domain/members.json
  def index
    @users = current_lodge.members.order("last_name asc")
  end

  # GET /:sub_domain/members/1
  # GET /:sub_domain/members/1.json
  def show
  end

  # GET /:sub_domain/members/new
  def new
    @user = User.new
  end

  # GET /:sub_domain/members/1/edit
  def edit
  end

  # POST /:sub_domain/members
  # POST /:sub_domain/members.json
  def create
  ...
  # PATCH/PUT /:sub_domain/members/1
  # PATCH/PUT /:sub_domain/members/1.json
  def update
    flash[:notice] = "User was successfully updated." if @user.update(params[:user])
    respond_with @user, location: lodge_members_path(current_lodge.sub_domain)
  end

  # DELETE /:sub_domain/members/1
  # DELETE /:sub_domain/members/1.json
  def destroy
    ...
    respond_with @user, location: lodge_members_path(current_lodge.sub_domain), notice: 'User was successfully removed.'
  end
  ...
  def verify_deletability
    if current_user.id == params[:id].to_i
      return redirect_to lodge_members_path(current_lodge.sub_domain), error: "Opps. You can't delete yourself."
    end
