...
describe ApplicationHelper do
  ...
  describe "admin_link_to" do
    it "returns an admin formatted link" do
      ...
      expect(admin_link).to eq("<li><a class=\"submenu\" href=\"/example-page\"><i class='icon-zoom-in'></i><span class=\"hidden-sm text\">Zoom</span></a></li>")
    end
  end
  ...
  describe "is_active_link?" do
    ...
    it "matches a given Regular Expression" do
  ...
  describe "markdown_render" do
    it "converts markdown formatted text to html" do
  ...
  #   it "returns comma seperated tag links" do
  #     tag_list = ["bar", "foo baz"]
  #     expect(helper.link_to_tags_inline(tag_list)).to eq("<a href=\"/blog/tags/bar\"><i class='icon-tag'></i> bar</a>, <a href=\"/blog/tags/foo-baz\"><i class='icon-tag'></i> foo baz</a>")
  #   end
  # end
